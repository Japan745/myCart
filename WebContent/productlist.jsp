		...
		<%int sno=0;
			...
			{%>
				...
				<tr>
					...
					<td><% out.println(rs.getString("product_id"));%>
					<td><% out.println(rs.getString("product_name"));%>
					<td><% out.println(rs.getString("quantity"));%>
					<td><i class="fa fa-usd"></i><% out.println(rs.getString("price"));%>
				</tr>
				<%}%>	
			<%}catch(Exception e){e.printStackTrace();}%>
			<tr>
			<td><a href="Adminhomepage.jsp"><button>Home page</button></a></td>
			</tr>
	</table>
