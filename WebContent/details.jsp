...
<%
	...
	<table id="customers">
		...
		<tr>
			<td><b>Total</b></td>
			<td></td>
			<td><b><%ResultSet rs1 = st1.executeQuery("select * from orders where order_id ='"+request.getParameter("id")+"'");
			List<Integer> price1 = new ArrayList<Integer>();
  			...
  			int amount=0;
  			while(pprice1.hasNext()){amount=amount+pprice1.next();}out.println(amount);%></b></td>
  		</tr>
	</table>
</body>
</html>